...
export const USERS_TABLE_SCHEMA = `
  CREATE TABLE IF NOT EXISTS users (
    ...
    avatar_base64 TEXT,
    agreed_to_terms_version TEXT,
    agreed_to_terms_at DATETIME,
    agreed_to_privacy_version TEXT,
    agreed_to_privacy_at DATETIME,
...
export const USERS_TABLE = {
  ...
  columns: {
    ...
    agreed_to_terms_version: { type: 'TEXT', nullable: true, description: 'Terms version accepted' },
    agreed_to_terms_at: { type: 'DATETIME', nullable: true, description: 'When terms were accepted' },
    agreed_to_privacy_version: { type: 'TEXT', nullable: true, description: 'Privacy version accepted' },
    agreed_to_privacy_at: { type: 'DATETIME', nullable: true, description: 'When privacy was accepted' },
