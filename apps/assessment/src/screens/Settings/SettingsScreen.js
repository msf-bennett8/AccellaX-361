...
export default function SettingsScreen({ onLogout }) {
  ...
  const handleResetSettings = () => {
    setModalConfig({
      ...
      message: 'Reset all settings to default values? Your data will not be affected.',
      type: 'warning',
      showCancel: true,
      confirmText: 'Reset',
      cancelText: 'Cancel',
  ...
  const handleDeleteAllData = () => {
    setModalConfig({
      ...
      message: 'This will permanently delete ALL assessments, kids, and data. This action CANNOT be undone! Are you absolutely sure?',
      type: 'error',
      showCancel: true,
        ...
        try {
          ...
          setModalConfig({
            ...
            onConfirm: async () => {
              ...
              // Call parent logout to update auth state
              if (onLogout) {
                await onLogout();
              }
            },
  ...
  const handleContactSupport = () => {
    setModalConfig({
      ...
      message: 'Choose your preferred contact method:',
      type: 'info',
      showCancel: true,
      confirmText: 'Email',
      cancelText: 'WhatsApp',
