...
export const GENERAL_FITNESS_METRICS = [
  ...
  {
  id: 'reaction_auditory',
  sportId: 'fitness',
  name: 'Auditory Reaction Time',
  category: 'general_fitness',
  type: 'reaction_auditory',
  unit: 'ms',
  minValue: 100,
  maxValue: 2000,
  displayOrder: 14,
  isDefault: true,
  description: 'Response time to auditory stimulus (beep + vibration)',
  attempts: 2,
},
{
  id: 'reaction_visual_simple',
  sportId: 'fitness',
  name: 'Simple Visual Reaction',
  category: 'general_fitness',
  type: 'reaction_visual_simple',
  unit: 'ms',
  minValue: 100,
  maxValue: 2000,
  displayOrder: 15,
  isDefault: true,
  description: 'Response time to screen color change',
  attempts: 2,
},
{
  id: 'reaction_color_choice',
  sportId: 'fitness',
  name: 'Color Choice Reaction',
  category: 'general_fitness',
  type: 'reaction_color_choice',
  unit: 'ms',
  minValue: 200,
  maxValue: 3000,
  displayOrder: 16,
  isDefault: true,
  description: 'Find and tap specific color among options',
  attempts: 2,
},
{
  id: 'reaction_direction_choice',
  sportId: 'fitness',
  name: 'Direction Choice Reaction',
  category: 'general_fitness',
  type: 'reaction_direction_choice',
  unit: 'ms',
  minValue: 200,
  maxValue: 3000,
  displayOrder: 17,
  isDefault: true,
  description: 'Tap correct arrow direction (left/right)',
  attempts: 2,
},
{
  id: 'reaction_go_nogo',
  sportId: 'fitness',
  name: 'Go/No-Go Inhibition Test',
  category: 'general_fitness',
  type: 'reaction_go_nogo',
  unit: 'ms',
  minValue: 200,
  maxValue: 3000,
  displayOrder: 18,
  isDefault: true,
  description: 'Tap on GO signal, inhibit on NO-GO',
  attempts: 4, // 3 GO + 1 NO-GO
},
];
